          ...
          <div className="comment__user-box">
            ...
            <div className="buttons">
              ...
              {comment.user.username === "juliusomo" ? null : (
                <button
                  aria-label="Reply to comment button"
                  className="button"
...
function Score({ comment, score, onUpdateScore }) {
  ...
  return (
    <div className="comment__score-box">
      <button
        aria-label="Increase the comment score button"
        onClick={handleUpdateScoreUp}
      >
      ...
      <p>{updateScore}</p>
      <button
        aria-label="Decrease the comment score button"
        onClick={handleUpdateScoreDown}
      >
